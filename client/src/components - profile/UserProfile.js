        ...
        <div className="w-full max-w-lg mt-12 bg-white rounded-lg shadow-lg p-6 sm:p-8">
          ...
          <div className="space-y-4">
            <div className="flex flex-col sm:flex-row justify-start items-center">
              <p className="font-medium text-text-dark">First Name: {user.firstname}</p>
            </div>
            <div className="flex flex-col sm:flex-row justify-start items-center">
              <p className="font-medium text-text-dark">Last Name: {user.lastname}</p>
            </div>
            <div className="flex flex-col sm:flex-row justify-start items-center">
              <p className="font-medium text-text-dark">Username: {user.username}</p>
            </div>
            <div className="flex flex-col sm:flex-row justify-start items-center">
              <p className="font-medium text-text-dark">Organization: {user.organization}</p>
            </div>
            <div className="flex flex-col sm:flex-row justify-start items-center">
              <p className="font-medium text-text-dark">Job Title: {user.jobtitle}</p>
            </div>
          </div>
